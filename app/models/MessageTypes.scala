...
object MessageType extends Enumerable.Implicits {
  ...
  case object InvalidXml                extends IeMetadata("IE917", "CC917A") with ArrivalMessage
  ...
  val arrivalValues: Seq[Directable] = Seq(ArrivalRejection, UnloadingPermission, UnloadingRemarksRejection, GoodsReleased, InvalidXml)
